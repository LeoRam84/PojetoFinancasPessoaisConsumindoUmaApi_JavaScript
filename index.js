...
async function fetchTransactions() {
  return await fetch('https://pojeto-financas-pessoais-consumindo-uma-api-java-script.vercel.app/transactions').then(res => res.json())
}
...
async function saveTransaction(ev) {
  ...
  if (id) {
    ...
    const response = await fetch(`https://pojeto-financas-pessoais-consumindo-uma-api-java-script.vercel.app/transactions/${id}`, {
      method: 'PUT',
      body: JSON.stringify({ name, amount }),
      headers: {
        'Content-Type': 'application/json'
    ...
    const response = await fetch('https://pojeto-financas-pessoais-consumindo-uma-api-java-script.vercel.app/transactions', {
      method: 'POST',
      body: JSON.stringify({ name, amount }),
      headers: {
        'Content-Type': 'application/json'
...
function createDeleteTransactionButton(id) {
  ...
  deleteBtn.addEventListener('click', async () => {
    await fetch(`https://pojeto-financas-pessoais-consumindo-uma-api-java-script.vercel.app/transactions/${id}`, { method: 'DELETE' }) // Acho que deleta do banco de dados, no caso o db.json !
